...
public class JavaSoundAudioFile implements AudioFileReader, AudioFileWriter {
    ...
    /**
     * Convert a Javasound AudioFormat object to a Beads SampleAudioFormat
     * object.
     * 
     * @param af
     * @return
    ...
    /**
     * Convert a Beads SampleAudioFormat object to a Javasound AudioFormat
     * object.
     * 
     * @param saf
     * @return
     */
    static public AudioFormat convertBeadsAudioFormatToJavasoundAudioFormat(
            SampleAudioFormat saf) {
        AudioFormat af = new AudioFormat(saf.getSampleRate(),
