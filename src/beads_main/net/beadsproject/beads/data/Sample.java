 ...
 * {@link SamplePlayer}. Sample data can also be
...
public class Sample {
    ...
    private float[][] theSampleData; // theSampleData[0] first channel,
                                     // theSampleData[1] second channel, etc..
    ...
    /**
     * Gets the current AudioFileReaderClass. This is an instantiation of a
     * class that implements {@link AudioFileReader} that Sample will use for
     * file reading operations. If unset or set to null Sample will use a
     * default.
     * 
     * @return
     */
    ...
    /**
     * Gets the current AudioFileWriterClass. This is an instantiation of a
     * class that implements {@link AudioFileWriter} that Sample will use for
     * file writing operations. If unset or set to null Sample will use a
     * default.
     * 
     * @return
     */
     ...
     */
    public void setAudioFileReaderClass(
            Class<? extends AudioFileReader> audioFileReaderClass) {
     ...
     */
    public void setAudioFileWriterClass(
            Class<? extends AudioFileWriter> audioFileWriterClass) {
    ...
    /**
     * This records the sample to a file with the specified AudioFile.Type. It
     * is BLOCKING.
     * 
     * @param fn
     *            The filename.
    ...
    public void write(String fn, AudioFileType type) throws IOException {
        write(fn, type, new SampleAudioFormat(this.sampleRate, 16,
                this.nChannels));
    }
    ...
    private void loadAudioFile(String file) throws IOException {
        // we have to deal with a bug in Tritonus: JavaSound doesn't accept
        // 24-bit wav but strangely Tritonus
        // interprets 24-bit wavs as mp3s. So we intercept all wavs and send
        ...
        try {
            audioFileReader = theRealAudioFileReaderClass.getConstructor()
                    .newInstance();
        } catch (Exception e1) {
            throw new IOException(
        ...
        try {
            ...
            throw new IOException("Problem loading file (class="
                    + audioFileReader.getClass() + ") " + file + ", "
                    + e.getMessage());
        }
