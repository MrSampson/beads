...
public class FFT extends FeatureExtractor<float[][], float[]> {
     ...
     * @param binNumber
     * @return the frequency corresponding to a specific bin
     */
     ...
     * @param freq
     *            The frequency
     * @return the average bin number corresponding to a particular frequency.
     */
    ...
    /*
     * All of the code below this line is taken from Holger Crysandt's
     * MPEG7AudioEnc project. See
     * http://mpeg7audioenc.sourceforge.net/copyright.html for license and
     * copyright.
     */
