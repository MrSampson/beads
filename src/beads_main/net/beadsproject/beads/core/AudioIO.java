 ...
 * By default, AudioContext creates a {@link JavaSoundAudioIO}.
 * 
 * @author Ollie Brown
 *
 */
public abstract class AudioIO {
    ...
    /**
     * Gets an audio input {@link UGen}. The argument specifies an array of
     * channel numbers that this UGen should serve. For example, the array {0,
     * 4, 2} should return a UGen with 3 outputs, corresponding to input
     * channels 1, 5 and 3 respectively on the audio device.
     * 
     * @param channels
